...
El HTML es el HyperText Markup Languaje y es el lenguaje estandár que se utiliza para estructurar las páginas web, ya que nos permite darle un esqueleto a nuestros sitio y organizar nuestra informacion de la manera adecuada. 
